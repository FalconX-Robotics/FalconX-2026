...
public class ManualFeedFromStorage extends Command {
    ...
    public ManualFeedFromStorage(Feeder feeder) {
    this.feeder = feeder;
    ...
    public void initialize() {
        feeder.setFeederAcceleration(acceleration);    //remove from storage
    }
